...
public class apiREST_TopicManager {
  ...
  public static void addPublisherToTopic(Topic topic) {
    try {
      ...
      // PrintWriter is used for printing the formatted representations of objects to a text-output stream
      ...
      out.println(json);
      out.flush();
      // Open communication link to the url
      ucon.connect();
      
      // Print the input stream using a BufferedReader
