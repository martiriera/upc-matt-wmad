...
public class WallViewServlet extends HttpServlet {
    ...
    protected void process(HttpServletRequest request, HttpServletResponse response)
        ...
        String messageOwner = "No user";
        String messageContent = "No message";
        if (msg != null) {
            messageOwner = msg.getOwner();
        ...
        out.println("<p>Sent by: <pre>" + messageOwner +"</pre></p>");
        out.println("<p>Message: <pre>" + messageContent +"</pre></p>");
        out.println("<HR WIDTH=\"100%\" SIZE=\"2\">");
