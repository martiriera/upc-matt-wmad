...
INSERT INTO `user` VALUES (1,'john','1234','2021-01-10 11:06:47');
...
CREATE TABLE `user_product` (
  ...
  CONSTRAINT `user_product_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`id`),
  CONSTRAINT `user_product_ibfk_2` FOREIGN KEY (`productId`) REFERENCES `product` (`id`)
...
-- Dump completed on 2021-01-10 19:55:10
